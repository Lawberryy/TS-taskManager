...
const taskForm = document.getElementById('taskForm'); // as HTMLFormElement est un type assertion pour indiquer que document.getElementById('taskForm') est un élément de formulaire HTML
...
taskForm.addEventListener('submit', (event) => {
    ...
    const taskTitle = document.getElementById('taskTitle').value; // as HTMLInputElement est un type assertion pour indiquer que document.getElementById('taskTitle') est un élément de formulaire HTML de type input
    const taskDescription = document.getElementById('taskDescription').value; // as HTMLTextAreaElement est un type assertion pour indiquer que document.getElementById('taskDescription') est un élément de formulaire HTML de type textarea
    const taskDueDate = new Date(document.getElementById('taskDueDate').value);
    const taskPriority = document.getElementById('taskPriority').value; // as HTMLSelectElement est un type assertion pour indiquer que document.getElementById('taskPriority') est un élément de formulaire HTML de type select
